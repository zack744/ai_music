...
| 主菜单 | 录音 | 生成中 | 播放 | 历史 |
|---|---|---|---|---|
| ![ui_menu](docs/demo/ui/ui_menu.png) | ![ui_recording](docs/demo/ui/ui_recording.png) | ![ui_generating](docs/demo/ui/ui_generating.png) | ![ui_playing](docs/demo/ui/ui_playing.png) | ![ui_history](docs/demo/ui/ui_history.png) |
